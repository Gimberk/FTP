...
namespace AAFDA.Controls
{
    ...
    public partial class AAFDATabControl : TabControl
    {
                    ...
                    for (int i = 0; i < TabCount; i++)
                    {
                        ...
                        if (BorderEdges && (i == SelectedIndex))
                        {
                            ...
                            if (Alignment == TabAlignment.Top || Alignment == TabAlignment.Bottom)
                            {
                                ...
                                {
                                    Helper.Swap(ref ptA, ref ptB); Helper.Swap(ref ptC, ref ptD);
                                }
                            }
                            ...
                            if (Alignment == TabAlignment.Right || Alignment == TabAlignment.Left)
                            {
                                ...
                                {
                                    Helper.Swap(ref ptA, ref ptC); Helper.Swap(ref ptB, ref ptD);
                                }
                            }
                        ...
                        //Indicator
                        {
                            ...
                            e.Graphics.FillRectangle(((Helper.TagToInt(TabPages[i]) == 1) ? brushAlternative : ((i == SelectedIndex) ? brushActiveIndicator : brushInActiveIndicator)), rectDivider);
                        }
